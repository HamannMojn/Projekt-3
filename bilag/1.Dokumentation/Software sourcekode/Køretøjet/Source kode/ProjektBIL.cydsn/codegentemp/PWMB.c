...
void PWMB_Stop(void) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG8(PWMB_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint8 PWMB_ReadCounter(void) 
    {
        ...
        return (CY_GET_REG8(PWMB_CAPTURE_LSB_PTR));
    }
...
void PWMB_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(PWMB_PERIOD_LSB_PTR, period);
    #endif /* (PWMB_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG8(PWMB_COMPARE1_LSB_PTR, compare);
        #endif /* (PWMB_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG8(PWMB_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWMB_UsingFixedFunction) */
    ...
    *******************************************************************************/
                                        ...
                                        
    {
        ...
        #else
            CY_SET_REG8(PWMB_COMPARE2_LSB_PTR, compare);
        #endif /* (PWMB_UsingFixedFunction) */
    }
#endif /* UseOneCompareMode */
    ...
    *******************************************************************************/
    ...
    {
        #if(PWMB_UsingFixedFunction)
            return ((uint8)CY_GET_REG16(PWMB_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG8(PWMB_COMPARE1_LSB_PTR));
        #endif /* (PWMB_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(PWMB_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWMB_UsingFixedFunction)
        return ((uint8)CY_GET_REG16(PWMB_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG8(PWMB_PERIOD_LSB_PTR));
    #endif /* (PWMB_UsingFixedFunction) */
}
