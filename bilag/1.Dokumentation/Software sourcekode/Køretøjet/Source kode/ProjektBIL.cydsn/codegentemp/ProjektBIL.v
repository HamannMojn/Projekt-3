// ======================================================================
// ProjektBIL.v generated from TopDesign.cysch
// 05/07/2020 at 13:21
...
module top ;
	...
	wire [0:0] tmpOE__Pin_PWMA_net;
	wire [0:0] tmpFB_0__Pin_PWMA_net;
	wire [0:0] tmpIO_0__Pin_PWMA_net;
	wire [0:0] tmpINTERRUPT_0__Pin_PWMA_net;
	electrical [0:0] tmpSIOVREF__Pin_PWMA_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_PWMA
		 (.oe(tmpOE__Pin_PWMA_net),
		  .y({Net_100}),
		  .fb({tmpFB_0__Pin_PWMA_net[0:0]}),
		  .io({tmpIO_0__Pin_PWMA_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_PWMA_net),
		  .interrupt({tmpINTERRUPT_0__Pin_PWMA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_PWMA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("7433394a-6c17-4de4-ab33-099ab3e5daaf"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("81e4c8da-8373-42c7-b9f6-f6ccb158fe9a"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_PWMB_net;
	wire [0:0] tmpFB_0__Pin_PWMB_net;
	wire [0:0] tmpIO_0__Pin_PWMB_net;
	wire [0:0] tmpINTERRUPT_0__Pin_PWMB_net;
	electrical [0:0] tmpSIOVREF__Pin_PWMB_net;

	cy_psoc3_pins_v1_10
		#(.id("a34d73a3-acf9-479b-9347-94532f7489bc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_PWMB
		 (.oe(tmpOE__Pin_PWMB_net),
		  .y({Net_1140}),
		  .fb({tmpFB_0__Pin_PWMB_net[0:0]}),
		  .io({tmpIO_0__Pin_PWMB_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_PWMB_net),
		  .interrupt({tmpINTERRUPT_0__Pin_PWMB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_PWMB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Bin1_net;
	wire [0:0] tmpFB_0__Bin1_net;
	wire [0:0] tmpIO_0__Bin1_net;
	wire [0:0] tmpINTERRUPT_0__Bin1_net;
	electrical [0:0] tmpSIOVREF__Bin1_net;

	cy_psoc3_pins_v1_10
		#(.id("bb9cf865-c683-4544-81c7-a83ca676e788"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Bin1
		 (.oe(tmpOE__Bin1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Bin1_net[0:0]}),
		  .io({tmpIO_0__Bin1_net[0:0]}),
		  .siovref(tmpSIOVREF__Bin1_net),
		  .interrupt({tmpINTERRUPT_0__Bin1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Bin1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Bin2_net;
	wire [0:0] tmpFB_0__Bin2_net;
	wire [0:0] tmpIO_0__Bin2_net;
	wire [0:0] tmpINTERRUPT_0__Bin2_net;
	electrical [0:0] tmpSIOVREF__Bin2_net;

	cy_psoc3_pins_v1_10
		#(.id("36f6dc42-0305-436f-9b6a-6e30bb94cb79"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Bin2
		 (.oe(tmpOE__Bin2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Bin2_net[0:0]}),
		  .io({tmpIO_0__Bin2_net[0:0]}),
		  .siovref(tmpSIOVREF__Bin2_net),
		  .interrupt({tmpINTERRUPT_0__Bin2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Bin2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("9eec95fe-5276-4b7d-880b-06fbb97b5210"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("772c3f22-da89-4dfe-a937-fd6b52862525"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ff7c9b41-dba2-4b54-a201-13da3b4f3424"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_PWM6_net;
	wire [0:0] tmpFB_0__Pin_PWM6_net;
	wire [0:0] tmpIO_0__Pin_PWM6_net;
	wire [0:0] tmpINTERRUPT_0__Pin_PWM6_net;
	electrical [0:0] tmpSIOVREF__Pin_PWM6_net;

	cy_psoc3_pins_v1_10
		#(.id("604a69bd-2cce-4391-89a5-4bd28fae61fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_PWM6
		 (.oe(tmpOE__Pin_PWM6_net),
		  .y({Net_1253}),
		  .fb({tmpFB_0__Pin_PWM6_net[0:0]}),
		  .io({tmpIO_0__Pin_PWM6_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_PWM6_net),
		  .interrupt({tmpINTERRUPT_0__Pin_PWM6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_PWM6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("46f748b3-e501-4f40-aa89-336357e319d2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6f3b4952-a05a-40f4-8d41-8abea5dd4654"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("80e79dd5-3e9a-42f5-b4f3-483507014abd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
