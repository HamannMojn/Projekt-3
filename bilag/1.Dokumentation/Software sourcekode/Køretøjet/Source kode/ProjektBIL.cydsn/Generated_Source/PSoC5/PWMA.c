...
void PWMA_Stop(void) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG8(PWMA_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint8 PWMA_ReadCounter(void) 
    {
        ...
        return (CY_GET_REG8(PWMA_CAPTURE_LSB_PTR));
    }
...
void PWMA_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(PWMA_PERIOD_LSB_PTR, period);
    #endif /* (PWMA_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG8(PWMA_COMPARE1_LSB_PTR, compare);
        #endif /* (PWMA_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG8(PWMA_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWMA_UsingFixedFunction) */
    ...
    *******************************************************************************/
                                        ...
                                        
    {
        ...
        #else
            CY_SET_REG8(PWMA_COMPARE2_LSB_PTR, compare);
        #endif /* (PWMA_UsingFixedFunction) */
    }
#endif /* UseOneCompareMode */
    ...
    *******************************************************************************/
    ...
    {
        #if(PWMA_UsingFixedFunction)
            return ((uint8)CY_GET_REG16(PWMA_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG8(PWMA_COMPARE1_LSB_PTR));
        #endif /* (PWMA_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(PWMA_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWMA_UsingFixedFunction)
        return ((uint8)CY_GET_REG16(PWMA_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG8(PWMA_PERIOD_LSB_PTR));
    #endif /* (PWMA_UsingFixedFunction) */
}
