...
#if (!PWMA_UsingFixedFunction)
    uint8   PWMA_ReadCounter(void) ;
    uint8 PWMA_ReadCapture(void) ;

    #if (PWMA_UseStatus)
            void PWMA_ClearFIFO(void) ;
    #endif /* (PWMA_UseStatus) */

    void    PWMA_WriteCounter(uint8 counter)
            ;
#endif /* (!PWMA_UsingFixedFunction) */

void    PWMA_WritePeriod(uint8 period)
        ;
uint8 PWMA_ReadPeriod(void) ;

#if (PWMA_UseOneCompareMode)
    void    PWMA_WriteCompare(uint8 compare)
            ;
    uint8 PWMA_ReadCompare(void) ;
#else
    void    PWMA_WriteCompare1(uint8 compare)
            ;
    uint8 PWMA_ReadCompare1(void) ;
    void    PWMA_WriteCompare2(uint8 compare)
            ;
    uint8 PWMA_ReadCompare2(void) ;
#endif /* (PWMA_UseOneCompareMode) */
...
**************************************/
#define PWMA_INIT_PERIOD_VALUE          (100u)
#define PWMA_INIT_COMPARE_VALUE1        (50u)
#define PWMA_INIT_COMPARE_VALUE2        (63u)
...
******************************** */
   ...
   #define PWMA_RT1_PTR                 ( (reg8 *)  PWMA_PWMHW__RT1)
       ...
       #if(PWMA_PWMModeIsCenterAligned)
           #define PWMA_PERIOD_LSB      (*(reg8 *)  PWMA_PWMUDB_sP8_pwmdp_u0__D1_REG)
           #define PWMA_PERIOD_LSB_PTR  ((reg8 *)   PWMA_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #else
           #define PWMA_PERIOD_LSB      (*(reg8 *)  PWMA_PWMUDB_sP8_pwmdp_u0__F0_REG)
           #define PWMA_PERIOD_LSB_PTR  ((reg8 *)   PWMA_PWMUDB_sP8_pwmdp_u0__F0_REG)
       #endif /* (PWMA_PWMModeIsCenterAligned) */

       #define PWMA_COMPARE1_LSB        (*(reg8 *)  PWMA_PWMUDB_sP8_pwmdp_u0__D0_REG)
       #define PWMA_COMPARE1_LSB_PTR    ((reg8 *)   PWMA_PWMUDB_sP8_pwmdp_u0__D0_REG)
       #define PWMA_COMPARE2_LSB        (*(reg8 *)  PWMA_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #define PWMA_COMPARE2_LSB_PTR    ((reg8 *)   PWMA_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #define PWMA_COUNTERCAP_LSB      (*(reg8 *)  PWMA_PWMUDB_sP8_pwmdp_u0__A1_REG)
       #define PWMA_COUNTERCAP_LSB_PTR  ((reg8 *)   PWMA_PWMUDB_sP8_pwmdp_u0__A1_REG)
       #define PWMA_COUNTER_LSB         (*(reg8 *)  PWMA_PWMUDB_sP8_pwmdp_u0__A0_REG)
       #define PWMA_COUNTER_LSB_PTR     ((reg8 *)   PWMA_PWMUDB_sP8_pwmdp_u0__A0_REG)
       #define PWMA_CAPTURE_LSB         (*(reg8 *)  PWMA_PWMUDB_sP8_pwmdp_u0__F1_REG)
       #define PWMA_CAPTURE_LSB_PTR     ((reg8 *)   PWMA_PWMUDB_sP8_pwmdp_u0__F1_REG)

   #else
        #if(CY_PSOC3) /* 8-bit address space */
            #if(PWMA_PWMModeIsCenterAligned)
               #define PWMA_PERIOD_LSB      (*(reg16 *) PWMA_PWMUDB_sP8_pwmdp_u0__D1_REG)
               #define PWMA_PERIOD_LSB_PTR  ((reg16 *)  PWMA_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #else
               #define PWMA_PERIOD_LSB      (*(reg16 *) PWMA_PWMUDB_sP8_pwmdp_u0__F0_REG)
               #define PWMA_PERIOD_LSB_PTR  ((reg16 *)  PWMA_PWMUDB_sP8_pwmdp_u0__F0_REG)
            #endif /* (PWMA_PWMModeIsCenterAligned) */

            #define PWMA_COMPARE1_LSB       (*(reg16 *) PWMA_PWMUDB_sP8_pwmdp_u0__D0_REG)
            #define PWMA_COMPARE1_LSB_PTR   ((reg16 *)  PWMA_PWMUDB_sP8_pwmdp_u0__D0_REG)
            #define PWMA_COMPARE2_LSB       (*(reg16 *) PWMA_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #define PWMA_COMPARE2_LSB_PTR   ((reg16 *)  PWMA_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #define PWMA_COUNTERCAP_LSB     (*(reg16 *) PWMA_PWMUDB_sP8_pwmdp_u0__A1_REG)
            #define PWMA_COUNTERCAP_LSB_PTR ((reg16 *)  PWMA_PWMUDB_sP8_pwmdp_u0__A1_REG)
            #define PWMA_COUNTER_LSB        (*(reg16 *) PWMA_PWMUDB_sP8_pwmdp_u0__A0_REG)
            #define PWMA_COUNTER_LSB_PTR    ((reg16 *)  PWMA_PWMUDB_sP8_pwmdp_u0__A0_REG)
            #define PWMA_CAPTURE_LSB        (*(reg16 *) PWMA_PWMUDB_sP8_pwmdp_u0__F1_REG)
            #define PWMA_CAPTURE_LSB_PTR    ((reg16 *)  PWMA_PWMUDB_sP8_pwmdp_u0__F1_REG)
        #else
            #if(PWMA_PWMModeIsCenterAligned)
               #define PWMA_PERIOD_LSB      (*(reg16 *) PWMA_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
               #define PWMA_PERIOD_LSB_PTR  ((reg16 *)  PWMA_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #else
               #define PWMA_PERIOD_LSB      (*(reg16 *) PWMA_PWMUDB_sP8_pwmdp_u0__16BIT_F0_REG)
               #define PWMA_PERIOD_LSB_PTR  ((reg16 *)  PWMA_PWMUDB_sP8_pwmdp_u0__16BIT_F0_REG)
            #endif /* (PWMA_PWMModeIsCenterAligned) */

            #define PWMA_COMPARE1_LSB       (*(reg16 *) PWMA_PWMUDB_sP8_pwmdp_u0__16BIT_D0_REG)
            #define PWMA_COMPARE1_LSB_PTR   ((reg16 *)  PWMA_PWMUDB_sP8_pwmdp_u0__16BIT_D0_REG)
            #define PWMA_COMPARE2_LSB       (*(reg16 *) PWMA_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #define PWMA_COMPARE2_LSB_PTR   ((reg16 *)  PWMA_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #define PWMA_COUNTERCAP_LSB     (*(reg16 *) PWMA_PWMUDB_sP8_pwmdp_u0__16BIT_A1_REG)
            #define PWMA_COUNTERCAP_LSB_PTR ((reg16 *)  PWMA_PWMUDB_sP8_pwmdp_u0__16BIT_A1_REG)
            #define PWMA_COUNTER_LSB        (*(reg16 *) PWMA_PWMUDB_sP8_pwmdp_u0__16BIT_A0_REG)
            #define PWMA_COUNTER_LSB_PTR    ((reg16 *)  PWMA_PWMUDB_sP8_pwmdp_u0__16BIT_A0_REG)
            #define PWMA_CAPTURE_LSB        (*(reg16 *) PWMA_PWMUDB_sP8_pwmdp_u0__16BIT_F1_REG)
            #define PWMA_CAPTURE_LSB_PTR    ((reg16 *)  PWMA_PWMUDB_sP8_pwmdp_u0__16BIT_F1_REG)
        #endif /* (CY_PSOC3) */

       #define PWMA_AUX_CONTROLDP1          (*(reg8 *)  PWMA_PWMUDB_sP8_pwmdp_u1__DP_AUX_CTL_REG)
       #define PWMA_AUX_CONTROLDP1_PTR      ((reg8 *)   PWMA_PWMUDB_sP8_pwmdp_u1__DP_AUX_CTL_REG)

   #endif /* (PWMA_Resolution == 8) */

   #define PWMA_COUNTERCAP_LSB_PTR_8BIT ( (reg8 *)  PWMA_PWMUDB_sP8_pwmdp_u0__A1_REG)
   #define PWMA_AUX_CONTROLDP0          (*(reg8 *)  PWMA_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG)
   #define PWMA_AUX_CONTROLDP0_PTR      ((reg8 *)   PWMA_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG)
