...
#if (!PWMB_UsingFixedFunction)
    uint8   PWMB_ReadCounter(void) ;
    uint8 PWMB_ReadCapture(void) ;

    #if (PWMB_UseStatus)
            void PWMB_ClearFIFO(void) ;
    #endif /* (PWMB_UseStatus) */

    void    PWMB_WriteCounter(uint8 counter)
            ;
#endif /* (!PWMB_UsingFixedFunction) */

void    PWMB_WritePeriod(uint8 period)
        ;
uint8 PWMB_ReadPeriod(void) ;

#if (PWMB_UseOneCompareMode)
    void    PWMB_WriteCompare(uint8 compare)
            ;
    uint8 PWMB_ReadCompare(void) ;
#else
    void    PWMB_WriteCompare1(uint8 compare)
            ;
    uint8 PWMB_ReadCompare1(void) ;
    void    PWMB_WriteCompare2(uint8 compare)
            ;
    uint8 PWMB_ReadCompare2(void) ;
#endif /* (PWMB_UseOneCompareMode) */
...
**************************************/
#define PWMB_INIT_PERIOD_VALUE          (100u)
#define PWMB_INIT_COMPARE_VALUE1        (50u)
...
******************************** */
   ...
   #define PWMB_RT1_PTR                 ( (reg8 *)  PWMB_PWMHW__RT1)
       ...
       #if(PWMB_PWMModeIsCenterAligned)
           #define PWMB_PERIOD_LSB      (*(reg8 *)  PWMB_PWMUDB_sP8_pwmdp_u0__D1_REG)
           #define PWMB_PERIOD_LSB_PTR  ((reg8 *)   PWMB_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #else
           #define PWMB_PERIOD_LSB      (*(reg8 *)  PWMB_PWMUDB_sP8_pwmdp_u0__F0_REG)
           #define PWMB_PERIOD_LSB_PTR  ((reg8 *)   PWMB_PWMUDB_sP8_pwmdp_u0__F0_REG)
       #endif /* (PWMB_PWMModeIsCenterAligned) */

       #define PWMB_COMPARE1_LSB        (*(reg8 *)  PWMB_PWMUDB_sP8_pwmdp_u0__D0_REG)
       #define PWMB_COMPARE1_LSB_PTR    ((reg8 *)   PWMB_PWMUDB_sP8_pwmdp_u0__D0_REG)
       #define PWMB_COMPARE2_LSB        (*(reg8 *)  PWMB_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #define PWMB_COMPARE2_LSB_PTR    ((reg8 *)   PWMB_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #define PWMB_COUNTERCAP_LSB      (*(reg8 *)  PWMB_PWMUDB_sP8_pwmdp_u0__A1_REG)
       #define PWMB_COUNTERCAP_LSB_PTR  ((reg8 *)   PWMB_PWMUDB_sP8_pwmdp_u0__A1_REG)
       #define PWMB_COUNTER_LSB         (*(reg8 *)  PWMB_PWMUDB_sP8_pwmdp_u0__A0_REG)
       #define PWMB_COUNTER_LSB_PTR     ((reg8 *)   PWMB_PWMUDB_sP8_pwmdp_u0__A0_REG)
       #define PWMB_CAPTURE_LSB         (*(reg8 *)  PWMB_PWMUDB_sP8_pwmdp_u0__F1_REG)
       #define PWMB_CAPTURE_LSB_PTR     ((reg8 *)   PWMB_PWMUDB_sP8_pwmdp_u0__F1_REG)

   #else
        #if(CY_PSOC3) /* 8-bit address space */
            #if(PWMB_PWMModeIsCenterAligned)
               #define PWMB_PERIOD_LSB      (*(reg16 *) PWMB_PWMUDB_sP8_pwmdp_u0__D1_REG)
               #define PWMB_PERIOD_LSB_PTR  ((reg16 *)  PWMB_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #else
               #define PWMB_PERIOD_LSB      (*(reg16 *) PWMB_PWMUDB_sP8_pwmdp_u0__F0_REG)
               #define PWMB_PERIOD_LSB_PTR  ((reg16 *)  PWMB_PWMUDB_sP8_pwmdp_u0__F0_REG)
            #endif /* (PWMB_PWMModeIsCenterAligned) */

            #define PWMB_COMPARE1_LSB       (*(reg16 *) PWMB_PWMUDB_sP8_pwmdp_u0__D0_REG)
            #define PWMB_COMPARE1_LSB_PTR   ((reg16 *)  PWMB_PWMUDB_sP8_pwmdp_u0__D0_REG)
            #define PWMB_COMPARE2_LSB       (*(reg16 *) PWMB_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #define PWMB_COMPARE2_LSB_PTR   ((reg16 *)  PWMB_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #define PWMB_COUNTERCAP_LSB     (*(reg16 *) PWMB_PWMUDB_sP8_pwmdp_u0__A1_REG)
            #define PWMB_COUNTERCAP_LSB_PTR ((reg16 *)  PWMB_PWMUDB_sP8_pwmdp_u0__A1_REG)
            #define PWMB_COUNTER_LSB        (*(reg16 *) PWMB_PWMUDB_sP8_pwmdp_u0__A0_REG)
            #define PWMB_COUNTER_LSB_PTR    ((reg16 *)  PWMB_PWMUDB_sP8_pwmdp_u0__A0_REG)
            #define PWMB_CAPTURE_LSB        (*(reg16 *) PWMB_PWMUDB_sP8_pwmdp_u0__F1_REG)
            #define PWMB_CAPTURE_LSB_PTR    ((reg16 *)  PWMB_PWMUDB_sP8_pwmdp_u0__F1_REG)
        #else
            #if(PWMB_PWMModeIsCenterAligned)
               #define PWMB_PERIOD_LSB      (*(reg16 *) PWMB_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
               #define PWMB_PERIOD_LSB_PTR  ((reg16 *)  PWMB_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #else
               #define PWMB_PERIOD_LSB      (*(reg16 *) PWMB_PWMUDB_sP8_pwmdp_u0__16BIT_F0_REG)
               #define PWMB_PERIOD_LSB_PTR  ((reg16 *)  PWMB_PWMUDB_sP8_pwmdp_u0__16BIT_F0_REG)
            #endif /* (PWMB_PWMModeIsCenterAligned) */

            #define PWMB_COMPARE1_LSB       (*(reg16 *) PWMB_PWMUDB_sP8_pwmdp_u0__16BIT_D0_REG)
            #define PWMB_COMPARE1_LSB_PTR   ((reg16 *)  PWMB_PWMUDB_sP8_pwmdp_u0__16BIT_D0_REG)
            #define PWMB_COMPARE2_LSB       (*(reg16 *) PWMB_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #define PWMB_COMPARE2_LSB_PTR   ((reg16 *)  PWMB_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #define PWMB_COUNTERCAP_LSB     (*(reg16 *) PWMB_PWMUDB_sP8_pwmdp_u0__16BIT_A1_REG)
            #define PWMB_COUNTERCAP_LSB_PTR ((reg16 *)  PWMB_PWMUDB_sP8_pwmdp_u0__16BIT_A1_REG)
            #define PWMB_COUNTER_LSB        (*(reg16 *) PWMB_PWMUDB_sP8_pwmdp_u0__16BIT_A0_REG)
            #define PWMB_COUNTER_LSB_PTR    ((reg16 *)  PWMB_PWMUDB_sP8_pwmdp_u0__16BIT_A0_REG)
            #define PWMB_CAPTURE_LSB        (*(reg16 *) PWMB_PWMUDB_sP8_pwmdp_u0__16BIT_F1_REG)
            #define PWMB_CAPTURE_LSB_PTR    ((reg16 *)  PWMB_PWMUDB_sP8_pwmdp_u0__16BIT_F1_REG)
        #endif /* (CY_PSOC3) */

       #define PWMB_AUX_CONTROLDP1          (*(reg8 *)  PWMB_PWMUDB_sP8_pwmdp_u1__DP_AUX_CTL_REG)
       #define PWMB_AUX_CONTROLDP1_PTR      ((reg8 *)   PWMB_PWMUDB_sP8_pwmdp_u1__DP_AUX_CTL_REG)

   #endif /* (PWMB_Resolution == 8) */

   #define PWMB_COUNTERCAP_LSB_PTR_8BIT ( (reg8 *)  PWMB_PWMUDB_sP8_pwmdp_u0__A1_REG)
   #define PWMB_AUX_CONTROLDP0          (*(reg8 *)  PWMB_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG)
   #define PWMB_AUX_CONTROLDP0_PTR      ((reg8 *)   PWMB_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG)
